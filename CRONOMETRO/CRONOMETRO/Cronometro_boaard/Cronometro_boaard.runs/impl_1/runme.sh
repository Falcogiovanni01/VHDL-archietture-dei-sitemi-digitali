...
HD_PWD='C:/Users/mauro/Desktop/CRONOMETRO/Cronometro_boaard/Cronometro_boaard.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Cronometro_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Cronometro_board.tcl -notrace
