...
HD_PWD='C:/Users/mauro/Desktop/CRONOMETRO/Cronometro_boaard/Cronometro_boaard.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cronometro_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cronometro_board.tcl
