...
HD_PWD='D:/ASDI/Rifai_es/tesina/omega_network/omega_network.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEM1_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEM1_2.tcl
