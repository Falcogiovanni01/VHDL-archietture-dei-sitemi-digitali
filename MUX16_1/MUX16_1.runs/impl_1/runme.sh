...
HD_PWD='D:/Rifai_es/MUX16_1/MUX16_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux16_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mux16_1.tcl -notrace
