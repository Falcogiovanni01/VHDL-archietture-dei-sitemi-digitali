...
ARCHITECTURE behavior OF tb_omega_network IS 
    ...
    -- Signals
    SIGNAL data_in_0, data_in_1, data_in_2, data_in_3 : STD_LOGIC_VECTOR(1 DOWNTO 0) := (others => 'U');
    SIGNAL src  : STD_LOGIC_VECTOR(1 DOWNTO 0)  := (others => 'U');  -- inizializzazione
    SIGNAL dst  : STD_LOGIC_VECTOR(1 DOWNTO 0)  := (others => 'U');  -- inizializzazione
    SIGNAL data_out_0, data_out_1, data_out_2, data_out_3 : STD_LOGIC_VECTOR(1 DOWNTO 0)  := (others => 'U');
...
BEGIN
    ...
    BEGIN    
        ...
        data_in_0 <= "00";  -- Input 0
        data_in_1 <= "01";  -- Input 1
        data_in_2 <= "10";  -- Input 2
        data_in_3 <= "11";  -- Input 3
