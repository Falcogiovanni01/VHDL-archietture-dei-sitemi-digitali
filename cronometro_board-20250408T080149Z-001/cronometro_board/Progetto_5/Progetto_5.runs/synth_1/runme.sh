...
HD_PWD='C:/Progetto/Progetto_5/Progetto_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chrono_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chrono_display.tcl
