...
HD_PWD='C:/Progetto/Progetto_5/Progetto_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chrono_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chrono_display.tcl -notrace
